...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-300 font-mono flex flex-col selection:bg-red-600 selection:text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div
              ...
              className="bg-zinc-900/40 border border-zinc-800 p-4 space-y-3"
            >
              <div className="flex items-center justify-between border-b border-zinc-800 pb-2.5">
                <h3 className="text-[10px] text-zinc-500 uppercase tracking-[0.2em]">
                  Detection Rules & Calibration
                </h3>
                <span className="text-[9px] uppercase px-1.5 py-0.5 border border-zinc-800 bg-zinc-950 text-zinc-400">
                  AUTONOMOUS LOGIC
                </span>
              </div>

              <p className="text-[11px] text-zinc-400 leading-relaxed uppercase">
                ALARM TRIGGERS ON <strong className="text-red-500">2 ACTIVE SIGNALS</strong> OR <strong className="text-red-500">1 PERSISTENT SIGNAL</strong>:
              </p>
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className={`p-2 border transition-all ${
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-[10px] px-1.5 py-0.5 border ${
                      metrics.isEyesClosed ? 'bg-red-600 border-red-500 text-white font-bold' : 'border-zinc-800 text-zinc-500'
                    }`}>
                ...
                <div className={`p-2 border transition-all ${
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-[10px] px-1.5 py-0.5 border ${
                      metrics.isYawning ? 'bg-yellow-600 border-yellow-500 text-black font-bold' : 'border-zinc-800 text-zinc-500'
                    }`}>
                ...
                <div className={`p-2 border transition-all ${
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-[10px] px-1.5 py-0.5 border ${
                      metrics.isHeadNodding ? 'bg-red-600 border-red-500 text-white font-bold' : 'border-zinc-800 text-zinc-500'
                    }`}>
              ...
              <div className="text-[10px] text-zinc-500 uppercase pt-1 border-t border-zinc-800/60">
      ...
      <footer className="px-6 py-3 bg-zinc-950 border-t border-zinc-800 flex flex-wrap justify-between items-center text-[10px] text-zinc-600 uppercase tracking-widest">
        <div>HW_VER: 2.4.0-STABLE | KERNEL: MP_VIS_v4.2</div>
        <div className="flex gap-4">
          <span>FPS: {metrics.fps}</span>
          <span>MEM: 442MB</span>
          <span className="text-emerald-500">Connection: Secure (Local)</span>
        </div>
      </footer>
